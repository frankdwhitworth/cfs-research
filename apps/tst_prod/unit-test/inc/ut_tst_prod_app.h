 ...
 *
 * Purpose:
 * Extra scaffolding functions for the tst_prod unit test
 *
 * Notes:
...
#ifndef UT_TST_PROD_APP_H
#define UT_TST_PROD_APP_H

/*
 * Necessary to include these here to get the definition of the
 * "TST_PROD_APP_Data_t" typedef.
 */
#include "tst_prod_app_events.h"
#include "tst_prod_app.h"

/*
 * Allow UT access to the global "TST_PROD_APP_Data" object.
 */
extern TST_PROD_APP_Data_t TST_PROD_APP_Data;

#endif /* UT_TST_PROD_APP_H */
