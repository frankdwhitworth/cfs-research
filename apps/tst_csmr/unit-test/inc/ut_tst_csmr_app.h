 ...
 *
 * Purpose:
 * Extra scaffolding functions for the tst_csmr unit test
 *
 * Notes:
...
#ifndef UT_TST_CSMR_APP_H
#define UT_TST_CSMR_APP_H

/*
 * Necessary to include these here to get the definition of the
 * "TST_CSMR_APP_Data_t" typedef.
 */
#include "tst_csmr_app_events.h"
#include "tst_csmr_app.h"

/*
 * Allow UT access to the global "TST_CSMR_APP_Data" object.
 */
extern TST_CSMR_APP_Data_t TST_CSMR_APP_Data;

#endif /* UT_TST_CSMR_APP_H */
